...
from ICT.model.DiTModel_pro import TransformerForDiffusion  # 使用上面修改后的 DiTModel
...
class DiffusionTransformerODEPolicy(BaseImagePolicy):
    ...
    def conditional_sample(self, cond, **kwargs):
        ...
        for k in range(self.num_inference_steps):
            ...
            v = self.model(trajectory, t, cond=cond)
    ...
    def compute_loss(self, batch):
        ...
        target_v = trajectory - x0
        
        pred_v = self.model(x_t, t, cond=cond)
